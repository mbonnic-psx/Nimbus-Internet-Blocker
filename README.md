...
High-level flow:
1. User sets a password → app generates a verifier string (e.g., `crypto_pwhash_str`)
...
│       └── Settings.razor       # App configuration (coming soon)
├── Layout/
...
│   ├── CustomSitesService.cs    # Custom sites management (WIP)
